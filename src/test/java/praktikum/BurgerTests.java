...
public class BurgerTests {
    ...
    public BurgerTests(float bunPrice, float ingredient1Price, float ingredient2Price, float expectedTotal) {
    ...
    public void addIngredientShouldAddIngredientToList() {
        ...
        assertEquals(mockIngredient1, actualIngredient);
    }
    ...
    public void moveIngredientShouldChangeIngredientPosition() {
        ...
        assertEquals(mockIngredient1, secondIngredient);
        assertEquals(mockIngredient2, firstIngredient);
    }
